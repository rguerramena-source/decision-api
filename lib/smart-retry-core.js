...
const DEFAULT_DECISION_CONFIG = {
  ...
  zombieDaysThreshold: 500,      // > 365 días => Zombie
  maxAttempts: 15,               // Límite estándar de intentos
  zombieMaxAttempts: 5,          // Límite de intentos para zombie
  freshDaysThreshold: 10,         // 0–5 días => Deuda fresca
